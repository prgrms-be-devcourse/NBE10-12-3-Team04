...
@Validated
data class ImageStorageProperties(@field:NotNull @field:Valid val upload: Upload, @field:NotNull @field:Valid val thumbnail: Thumbnail, @field:NotNull @field:Valid val ext: Ext) {
