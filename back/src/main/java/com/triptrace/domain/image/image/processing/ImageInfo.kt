...
class ImageInfo {
    ...
    var orientation: ExifOrientation? = ExifOrientation.NORMAL
        private set
    ...
    fun setCapturedAt(value: LocalDateTime?) {
        capturedAt = value
    }
    ...
    fun setOrientation(value: ExifOrientation?) {
        orientation = value
    }

    fun setFileSize(value: Long?) {
        fileSize = value
    }
}
